...
class Privacy(Cog):
    ...
    async def privacy(self, ctx):
        ...
        **Data**
        ...
        stats with the mute_roll command, commands you have used and 
        ...
        **Agreement**
        ...
        your data removed (not including moderation data) and command `do_not_track` will prevent the bot from saving some data of you.
        '''
