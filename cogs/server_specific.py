...
FILTERED_ROLES = {disnake.Role(guild=None, state=None, data={**base_role, "id": id_, "name": ""})
                  for id_ in FILTERED_ROLES}

AVAILABLE_ROLES = {10: {
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 320674825423159296, "name": "No dignity"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 322063025903239178, "name": "meem"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 320667990116794369, "name": "HELL 2 U"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 320673902047264768, "name": "I refuse"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 322737580778979328, "name": "SHIIIIIIIIIIIIZZZZZAAAAAAA"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 322438861537935360, "name": "CHEW"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 322425271791910922, "name": "deleted-role"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 322760382542381056, "name": "Couldn't beat me 1 2 3"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 322761051303051264, "name": "ok"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 322416531520749568, "name": "degenerate"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 325627566406893570, "name": "he"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 325415104894074881, "name": "ew no"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 325629356309479424, "name": "she"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 326096831777996800, "name": "new tole"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 329331992778768397, "name": "to role or not to role"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 329333048917229579, "name": "DORARARARARARARARARARARARARARARARA"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 330058759986479105, "name": "The entire horse"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 330079869599744000, "name": "baguette"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 330080088597200896, "name": "4 U"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 330080062441259019, "name": "big guy"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 336219409251172352, "name": "The whole horse"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 338238407845216266, "name": "ok masta let's kill da ho"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 338238532101472256, "name": "BEEEEEEEEEEEEEETCH"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 340950870483271681, "name": "FEEL THE HATRED OF TEN THOUSAND YEARS!"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 349982610161926144, "name": "Fruit mafia"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 380074801076633600, "name": "Attack helicopter"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 381762837199978496, "name": "Gappy makes me happy"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 389133241216663563, "name": "Comfortably numb"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 398957784185438218, "name": "Bruce U"}),
    disnake.Role(guild=None, state=None,  data={**base_role, "id": 523192033544896512, "name": "Today I will +t random ham"}),
    disnake.Role(guild=None, state=None, data={**base_role, "id": 884495493160402955, "name": "Fuck you leatherman"}),
    disnake.Role(guild=None, state=None, data={**base_role, "id": 884495647854710794, "name": "ok i pull up"}),
    },

    365: {
        disnake.Role(guild=None, state=None, data={**base_role, "id": 321863210884005906, "name": "What did you say about my hair"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 320885539408707584, "name": "Your next line's gonna be"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 321285882860535808, "name": "JJBA stands for Johnny Joestar's Big Ass"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 330317213133438976, "name": "Dik brothas"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 322667100340748289, "name": "Wannabe staff"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 324084336083075072, "name": "rng fucks me in the ASS!"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 884495079518138408, "name": "Jej"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 884496543590285373, "name": "Floppa enthusiast"}),
    },

    548: {
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 323486994179031042, "name": "I got 2 steel balls and I ain't afraid to use them"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 321697480351940608, "name": "ORA ORA ORA ORA ORA ORA ORA ORA ORA ORA MUDA MUDA MUDA MUDA MUDA MUDA MUDA MUDA"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 330440908187369472, "name": "CEO of Heterosexuality"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 329350731918344193, "name": "4 balls"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 358615843120218112, "name": "weirdo"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 336437276156493825, "name": "Wannabe owner"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 327519034545537024, "name": "food"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 1397928859772387388, "name": "CEO of Homosexuality"})

    },

    730: {
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 326686698782195712, "name": "Made in heaven"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 320916323821682689, "name": "Filthy acts at a reasonable price"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 321361294555086858, "name": "Speedwagon best waifu"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 320879943703855104, "name": "Passione boss"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 320638312375386114, "name": "Dolphin l̶o̶v̶e̶r̶ fucker"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 318683559462436864, "name": "Sex pistols ( ͡° ͜ʖ ͡°)"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 318843712098533376, "name": "Taste of a liar"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 323474940298788864, "name": "Wannabe bot"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 325712897843920896, "name": "Can't spell s0hvaperuna"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 1061291489960923227, "name": "Gary loves you"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 1061706836723634196, "name": "Smelled the pine trees along the way"}),
    },

    900: {
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 321310583200677889, "name": "The fucking strong"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 318432714984521728, "name": "Za Warudo"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 376789104794533898, "name": "no u"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 348900633979518977, "name": "Role to die"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 349123036189818894, "name": "koichipose"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 318383761953652741, "name": "The Ashura"}),
        disnake.Role(guild=None, state=None,  data={**base_role, "id": 1260901563128352781, "name": "CURSE YOU BAYLE!"}),
    },

    1500: {
        disnake.Role(guild=None, state=None, data={**base_role, "id": 968563116130578472, "name": "Radahn festival enjoyer"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 978028956395634779, "name": "Saucy jack"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 1128975230447140894, "name": "member of the En Family"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 1201860328573648936, "name": "Nah, I'd win"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 1201860468734709780, "name": "Perhaps, this is hell"}),
        disnake.Role(guild=None, state=None, data={**base_role, "id": 369042760457519105, "name": "modertarter"}),
    }
}
